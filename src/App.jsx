...
function FormSplitBill({selectedFriend, onSplitBill}){
  ...
  return <form className="form-split-bill" onSubmit={handleSubmit}>
    ...
    <label>💰 Bill value</label>
      ...
      <input type="text" value={paidByUser} onChange={
        e=>setPaidByUser(Number(e.target.value)> bill ? paidByUser : Number(e.target.value))}/>
...
function FriendsList({friends, onSelect, selectedFriend}){
  ...
  return <ul>
    ...
    {friends.map((friend)=>{
      ...
      return <Friend friend = {friend} key={friend.id} onSelect={onSelect} selectedFriend={selectedFriend}/>
    })
    }
...
function App() {
  ...
  function handleSplitBill(value){
    ...
    setFriends(friends => { return friends.map(friend=>{
